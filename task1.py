...
def load_and_preprocess_data(file_path):
    ...
    rolling_median = df["depth_raw"].rolling(window=7, center=True).median()
    ...
    # 3. Noise Reduction (Brownie Points): Smooth random sensor jitter
...
# Plot elements: Raw erratic/noisy data vs Cleaned & Smoothed depth profile
...
# Surface is at top (0m), deep sea downwards
